class BaseImage(object):
    ...
    def load(self, image_path):
        """
        Load a Code5 image file
        """
        raise NotImplementedError("BaseImage.load")

    def drawrect(self, row, col):
        """
        Draw a single rectangle of the Code5 code.
        """
        raise NotImplementedError("BaseImage.drawrect")

    def readrect(self, row, col):
        """
        Read a single rectangle of the Code5 code.
        """
        raise NotImplementedError("BaseImage.readrect")
